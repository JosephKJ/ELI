...
# ---------------------------------------------------------------------------- #
# Use EBM based aligner
# ---------------------------------------------------------------------------- #
_C.EBM_ALIGNER = CN()
_C.EBM_ALIGNER.ENABLE = False
_C.EBM_ALIGNER.FEAT_SAVE_LOCATION = 'features'
_C.EBM_ALIGNER.EBM_LATENT_DIM = 2048
_C.EBM_ALIGNER.EBM_N_LAYERS = 1
_C.EBM_ALIGNER.EBM_N_HIDDEN_UNITS = 64
_C.EBM_ALIGNER.MAX_ITER = 1000
_C.EBM_ALIGNER.EBM_LR = 0.0001
_C.EBM_ALIGNER.N_LANGEVIN_STEPS = 30
_C.EBM_ALIGNER.LANGEVIN_LR = 0.1
_C.EBM_ALIGNER.EMA_DECAY = 0.89
_C.EBM_ALIGNER.LOG_ITER = 50
_C.EBM_ALIGNER.BATCH_SIZE = 128
